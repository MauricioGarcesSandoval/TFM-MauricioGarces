...
os.makedirs("graficas_lr/hour=3", exist_ok=True)
...
plt.legend()
plt.grid()
plt.savefig("graficas_lr/hour=3/roc_curve.png")
plt.close()
...
plt.grid()
plt.savefig("graficas_lr/hour=3/pr_curve.png")
plt.close()
...
# ============================================================
import joblib
joblib.dump(model, "modelos/lr_model_3h.json")
