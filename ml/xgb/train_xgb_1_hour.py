...
plt.grid()
plt.savefig("graficas/hour=1/roc_curve.png")
plt.close()
...
plt.grid()
plt.savefig("graficas/hour=1/pr_curve.png")
plt.close()
...
plt.legend(loc="best")
plt.grid()
plt.savefig("graficas/hour=1/threshold_curve.png")
plt.close()
...
plt.tight_layout()
plt.savefig("graficas/hour=1/feature_importance.png")
plt.close()
...
model.save_model("modelos/xgboost_model_1h.json")
